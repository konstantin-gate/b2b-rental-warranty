...
public class PaymentRepositoryTest {
     ...
     */
    @Test
    public fun listPaymentsParsesStatuses(): Unit = runTest {
        val listJson = """
            [
     ...
     */
    @Test
    public fun payPaymentReturnsUpdatedStatus(): Unit = runTest {
     ...
     */
    @Test
    public fun payPayment409ThrowsConflict(): Unit = runTest {
        val mockEngine = MockEngine { request ->
